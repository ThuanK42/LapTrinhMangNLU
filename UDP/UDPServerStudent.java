...
public class UDPServerStudent extends Thread {
	...
	public static ArrayList<Student> listStudent() {
		list.add(new Student( "NguyenVanA", 20, 8));
		list.add(new Student( "NguyenVanB", 21, 9));
		list.add(new Student( "NguyenVanC", 26, 8));
		list.add(new Student( "NguyenVanD", 22, 9));
		list.add(new Student( "NguyenVanE", 25, 10));
		list.add(new Student( "NguyenVanF", 18, 9));
		return list;
