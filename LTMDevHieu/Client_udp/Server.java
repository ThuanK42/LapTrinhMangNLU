...
public class Server extends Thread {
	...
	// Find upper age
	public  String findUpperByAge(int age) {
		String s = "";
		for (Student st : listStudent) {
			if (st.getAge() >= age) {
				s += st;
	...
	// Find under age
	public  String findUnderByAge(int age) {
		String s = "";
		for (Student st : listStudent) {
			if (st.getAge() <= age) {
				s += st;
	...
	// Find upper score
	public  String findUpperByScore(double score) {
		String s = "";
		for (Student st : listStudent) {
	...
	// Find under score
	public  String findUnderByScore(double score) {
		String s = "";
		for (Student st : listStudent) {
			if (st.getScore() <= score) {
				s += st;
