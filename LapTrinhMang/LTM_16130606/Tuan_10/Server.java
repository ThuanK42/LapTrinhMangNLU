...
public class Server extends Thread {
    ...
    public static void createList() {
        Student st1 = new Student("TRIEU", 20, 10);
        Student st2 = new Student("DINH", 19, 8);
        Student st3 = new Student("LY", 26, 9);
        Student st4 = new Student("TRAN", 20, 3);
        Student st5 = new Student("HAN", 13, 10);
        Student st6 = new Student("DUONG", 19, 10);
        Student st7 = new Student("TONG", 22, 10);
        Student st8 = new Student("NGUYEN", 20, 1);
